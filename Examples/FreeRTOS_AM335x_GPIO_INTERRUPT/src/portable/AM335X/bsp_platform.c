...
void vSetupTickInterrupt()
{
    ...
    ConsoleUtilsPrintf("Timer interrupt enabled OK\r\n");
...
// }
// xInsideISR tracks whether we're inside an ISR context (used by FPU-safe handler)
volatile portBASE_TYPE xInsideISR = 0;
